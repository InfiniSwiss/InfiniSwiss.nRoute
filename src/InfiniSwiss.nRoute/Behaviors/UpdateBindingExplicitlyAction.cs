...
{
    public class UpdateBindingExplicitlyAction
        : TriggerAction<FrameworkElement>
    {
        ...
        public static readonly DependencyProperty PropertyNameProperty =
            DependencyProperty.Register("PropertyName", typeof(string), typeof(UpdateBindingExplicitlyAction),
        ...
        protected override void Invoke(object parameter)
        {
            ...
            var _binding = AssociatedObject.GetBindingExpression(_dependencyProperty);
        ...
        {
            ((UpdateBindingExplicitlyAction)d).ResetDependencyPropertyCache();
        }
        ...
        private void ResolveDependnecyProperty()
        {
            ...
            // get the field
            var _field = AssociatedObject.GetType().GetField(_propName,
            ...
            // and get the dp
            _dependencyProperty = (DependencyProperty)_field.GetValue(AssociatedObject);
            if (_field == null)
                throw new InvalidOperationException(string.Format(DP_NOTFOUND_ERROR_FORMAT, PropertyName));
        }
