...
{
    public class NullValueInteractivityBehavior
        : Behavior<UIElement>
    {
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(object), typeof(NullValueInteractivityBehavior),
        ...
        {
            ((NullValueInteractivityBehavior)d).UpdateInteractivity(e.NewValue);
        }

        private void UpdateInteractivity(object value)
        {
            if (this.AssociatedObject == null) return;

            var _isInteractive = (value != null);
